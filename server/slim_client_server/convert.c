...
// globál
char * int2str(char * s, unsigned int i);
char * int2strn(char * s, int n, unsigned int i);
 ...
 * např 0056
 */
char * int2str(char *s, unsigned int cislo){
 ...
 */
char * int2strn(char * s, int len, unsigned int cislo){
//  char s[6]= "     \0";
  //unsigned int zaklad;
  int nenula = 0;
  int i;
  unsigned int zaklady [5] = {1,10,100,1000,10000};
