...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/MinGW-Windows/slim_client_server.exe

dist/Release/MinGW-Windows/slim_client_server.exe: ${OBJECTFILES}
	${MKDIR} -p dist/Release/MinGW-Windows
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/slim_client_server ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/dlst_scr.o: nbproject/Makefile-${CND_CONF}.mk dlst_scr.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/dlst_scr.o dlst_scr.c

${OBJECTDIR}/dat_scr.o: nbproject/Makefile-${CND_CONF}.mk dat_scr.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/dat_scr.o dat_scr.c
...
${OBJECTDIR}/slowloop.o: nbproject/Makefile-${CND_CONF}.mk slowloop.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/slowloop.o slowloop.c

${OBJECTDIR}/mysql_connect.o: nbproject/Makefile-${CND_CONF}.mk mysql_connect.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/mysql_connect.o mysql_connect.c
...
${OBJECTDIR}/hlp_scr.o: nbproject/Makefile-${CND_CONF}.mk hlp_scr.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/hlp_scr.o hlp_scr.c
...
${OBJECTDIR}/measure.o: nbproject/Makefile-${CND_CONF}.mk measure.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/measure.o measure.c
...
${OBJECTDIR}/stp_scr.o: nbproject/Makefile-${CND_CONF}.mk stp_scr.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/stp_scr.o stp_scr.c

${OBJECTDIR}/vizualizace.o: nbproject/Makefile-${CND_CONF}.mk vizualizace.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/vizualizace.o vizualizace.c

${OBJECTDIR}/data_serial.o: nbproject/Makefile-${CND_CONF}.mk data_serial.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/data_serial.o data_serial.c
...
${OBJECTDIR}/msr_scr.o: nbproject/Makefile-${CND_CONF}.mk msr_scr.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/msr_scr.o msr_scr.c

${OBJECTDIR}/gui_toolbox.o: nbproject/Makefile-${CND_CONF}.mk gui_toolbox.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/gui_toolbox.o gui_toolbox.c

${OBJECTDIR}/keyfcn.o: nbproject/Makefile-${CND_CONF}.mk keyfcn.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/keyfcn.o keyfcn.c

${OBJECTDIR}/data_file.o: nbproject/Makefile-${CND_CONF}.mk data_file.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/data_file.o data_file.c

${OBJECTDIR}/camera.o: nbproject/Makefile-${CND_CONF}.mk camera.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/camera.o camera.c
...
.clean-conf:
	${RM} -r build/Release
	${RM} dist/Release/MinGW-Windows/slim_client_server.exe
