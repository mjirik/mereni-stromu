 ...
 * \file convert.c
 * \brief
 * Zde jsou provádìny konverze èíselných typù na string.
 */
...
/**
 * Funkce vyplní daný øetìzec mezerami. Poèet mezer je urèen argumentem len. Za mezery je umístìn
 * znak '\0'.
 */
 ...
 * èíslo. Pokud je øetìzec pøíliš krátký, dojde k vypsání chybové zprávy. Zarovnává se vpravo.
...
*/
  ...
  if ((cislo/zaklady[i]) >= 10){ //tohle testuje jestli neni èíslo na víc míst než je možný zobrazit
    //new_error(85);
  }
  else{
    if (i < 4)
